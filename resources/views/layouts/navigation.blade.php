        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4 space-y-2">
                    <a href="{{ route('login') }}" class="block text-sm text-gray-700 dark:text-gray-300">Login</a>
                    <a href="{{ route('register') }}" class="block text-sm text-gray-700 dark:text-gray-300">Register</a>
                </div>
            </div>
        @endauth
    </div>
